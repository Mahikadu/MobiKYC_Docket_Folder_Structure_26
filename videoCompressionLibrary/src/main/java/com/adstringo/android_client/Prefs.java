...
//	public static final String DEFAULT_WORK_FOLDER = "/sdcard/videokit/";
	...
	public static boolean no4androidLog = false;
	private static String _versionName = "9.0.05";

	public static boolean isComplex(Context ctx) {
		boolean isComplex = getSharedPreferences(ctx).getBoolean("project4android_isComplex", true);
		Log.i(Prefs.TAG, "project4android_isComplex: " + isComplex);
		return isComplex;
	}

	public static void setComplex(Context ctx, boolean isComplex) {
		Log.i(Prefs.TAG, "project4android_setComplex: " + isComplex);
		SharedPreferences.Editor editor = getSharedPreferences(ctx).edit();
		editor.putBoolean("project4android_isComplex", isComplex);
		editor.commit();
	...
	*/
	...
	public static String get4androidLogFilePath() {
		return getWorkFolder() + "project4android.log";
	}
