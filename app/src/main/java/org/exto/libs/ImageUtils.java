...
//import static org.exto.mobescan.kyc.LoginActivity.USER_NAME_FTP_ROOT_FOLDER;
        ...
        if (resolution.equalsIgnoreCase("Original") && quality.equalsIgnoreCase("Original")) {
            try {
                ...
                try {
                    ...
                    ftpCreateDirectoryTree(client, "/" + LoginActivity.USER_NAME_FTP_ROOT_FOLDER + "/" + scanid);
